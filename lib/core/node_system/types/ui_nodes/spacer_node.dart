...
class SpacerNode extends Node {
  ...
  SpacerNode({
    ...
    Rect bounds = const Rect(x: 0, y: 0, width: 50, height: 50),
    bool isLocked = false,
    bool isVisible = true,
  }) : super(
          id: id,
  ...
  factory SpacerNode.fromJson(Map<String, dynamic> json) {
    return SpacerNode(
      ...
      bounds: json['bounds'] != null ? Rect.fromJson(json['bounds']) : const Rect(x: 0, y: 0, width: 50, height: 50),
  ...
  List<PropertyDefinition> get propertyDefinitions => [
        const PropertyDefinition(name: 'flex', type: PropertyType.integer, defaultValue: 1, displayName: 'Flex'),
      ];
