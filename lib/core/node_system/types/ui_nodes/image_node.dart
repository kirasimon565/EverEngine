...
class ImageNode extends Node {
  ...
  List<PropertyDefinition> get propertyDefinitions => [
        PropertyDefinition(name: 'source', type: PropertyType.image, displayName: 'Image Source', defaultValue: ''),
  ...
  Widget buildPreview(BuildContext context) {
    ...
    return Container(
      ...
      child: const Center(child: Icon(IconData(0xe333, fontFamily: 'MaterialIcons'))), // Icons.image fallback
    );
  }
