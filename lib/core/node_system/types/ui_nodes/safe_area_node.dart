...
class SafeAreaNode extends Node {
  ...
  List<PropertyDefinition> get propertyDefinitions => [
        const PropertyDefinition(name: 'left', type: PropertyType.boolean, defaultValue: true, displayName: 'Safe Left'),
        const PropertyDefinition(name: 'top', type: PropertyType.boolean, defaultValue: true, displayName: 'Safe Top'),
        const PropertyDefinition(name: 'right', type: PropertyType.boolean, defaultValue: true, displayName: 'Safe Right'),
        const PropertyDefinition(name: 'bottom', type: PropertyType.boolean, defaultValue: true, displayName: 'Safe Bottom'),
      ];
