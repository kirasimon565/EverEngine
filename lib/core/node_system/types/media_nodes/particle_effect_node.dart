...
class ParticleEffectNode extends Node {
  static const String typeString = 'ParticleEffectNode';
  ...
  factory ParticleEffectNode.fromJson(Map<String, dynamic> json) {
    return ParticleEffectNode(
  ...
  List<PropertyDefinition> get propertyDefinitions => [
        const PropertyDefinition(name: 'effectPreset', type: PropertyType.string, defaultValue: 'snow', displayName: 'Preset'),
      ];

  @override
  Widget buildPreview(BuildContext context) {
    return Container(
      decoration: BoxDecoration(border: Border.all(color: Colors.blueAccent, style: BorderStyle.solid)),
      child: const Center(
        child: Text("Particles", style: TextStyle(color: Colors.blueAccent)),
      ),
    );
  }
