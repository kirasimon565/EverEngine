...
class ChapterEndNode extends Node {
  static const String typeString = 'ChapterEndNode';
  ...
  factory ChapterEndNode.fromJson(Map<String, dynamic> json) {
  ...
  List<PropertyDefinition> get propertyDefinitions => [
        const PropertyDefinition(name: 'nextChapter', type: PropertyType.string, defaultValue: '', displayName: 'Next Chapter'),
      ];
  ...
  Widget buildPreview(BuildContext context) {
    return Container(
      ...
      child: const Center(
        child: Text("End of Chapter", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
      ),
    );
  }
