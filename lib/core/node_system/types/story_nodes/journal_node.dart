...
class JournalNode extends Node {
  static const String typeString = 'JournalNode';
  ...
  factory JournalNode.fromJson(Map<String, dynamic> json) {
    return JournalNode(
  ...
  Widget buildPreview(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          color: Colors.brown[300], borderRadius: BorderRadius.circular(8)),
