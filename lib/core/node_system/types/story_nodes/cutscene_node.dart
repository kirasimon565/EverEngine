...
class CutsceneNode extends Node {
  ...
  List<PropertyDefinition> get propertyDefinitions => [
        const PropertyDefinition(name: 'videoSource', type: PropertyType.string, defaultValue: '', displayName: 'Video Source'),
        const PropertyDefinition(name: 'skippable', type: PropertyType.boolean, defaultValue: true, displayName: 'Skippable'),
      ];
