...
class CutsceneNode extends Node {
  static const String typeString = 'CutsceneNode';
  ...
  CutsceneNode({
    ...
    super.triggers,
    super.metadata,
    super.bounds = const Rect(x: 0, y: 0, width: 300, height: 169),
    super.isLocked,
    super.isVisible,
  }) : super(
          type: typeString,
  ...
  factory CutsceneNode.fromJson(Map<String, dynamic> json) {
    return CutsceneNode(
      ...
      bounds: json['bounds'] != null
          ...
          : const Rect(x: 0, y: 0, width: 300, height: 169),
