...
class SceneLoaderNode extends Node {
  static const String typeString = 'SceneLoaderNode';
  ...
  factory SceneLoaderNode.fromJson(Map<String, dynamic> json) {
    return SceneLoaderNode(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text("Load: \${properties['sceneName']?.value}",
