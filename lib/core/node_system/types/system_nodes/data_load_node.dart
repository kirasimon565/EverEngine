...
class DataLoadNode extends Node {
  static const String typeString = 'DataLoadNode';
  ...
  factory DataLoadNode.fromJson(Map<String, dynamic> json) {
    return DataLoadNode(
  ...
  List<PropertyDefinition> get propertyDefinitions => [
        const PropertyDefinition(name: 'saveSlot', type: PropertyType.integer, defaultValue: 1, displayName: 'Save Slot'),
      ];

  @override
  Widget buildPreview(BuildContext context) {
    return Container(
      decoration: BoxDecoration(color: Colors.blueGrey[600], borderRadius: BorderRadius.circular(8)),
      ...
      child: Column(
        ...
        children: const [
          ...
          SizedBox(height: 4),
          Text("Load Data", style: TextStyle(color: Colors.white, fontSize: 12)),
        ],
      ),
    );
  }
