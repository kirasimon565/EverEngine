...
class DataSaveNode extends Node {
  static const String typeString = 'DataSaveNode';
  ...
  factory DataSaveNode.fromJson(Map<String, dynamic> json) {
    return DataSaveNode(
  ...
  Widget buildPreview(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          color: Colors.blueGrey[600], borderRadius: BorderRadius.circular(8)),
