...
class NetworkRequestNode extends Node {
  ...
  List<PropertyDefinition> get propertyDefinitions => [
        const PropertyDefinition(name: 'url', type: PropertyType.string, defaultValue: '', displayName: 'URL'),
        const PropertyDefinition(name: 'method', type: PropertyType.string, defaultValue: 'GET', displayName: 'Method'),
      ];

  @override
  Widget buildPreview(BuildContext context) {
    return Container(
      decoration: BoxDecoration(color: Colors.cyan[800], borderRadius: BorderRadius.circular(8)),
      ...
      child: Column(
        ...
        children: const [
          ...
          SizedBox(height: 4),
          Text("Network Request", style: TextStyle(color: Colors.white, fontSize: 12)),
        ],
      ),
    );
  }
